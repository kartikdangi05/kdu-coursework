...
import com.handson.security.filters.TokenValidatorFilter;
    ...
    public SecurityFilterChain customDefaultFilter(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .requestMatchers("/users/getUsers").hasAnyRole("BASIC", "ADMIN")
                        .requestMatchers("/users/getUser/{name}").hasAnyRole("BASIC", "ADMIN")
